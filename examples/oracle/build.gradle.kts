...
dependencies {
    implementation("com.oracle.oci.sdk:oci-java-sdk-objectstorage-generated:3.91.0")
    implementation("com.oracle.oci.sdk:oci-java-sdk-common-httpclient-jersey:3.91.0")
