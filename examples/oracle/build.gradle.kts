...
dependencies {
    implementation("com.oracle.oci.sdk:oci-java-sdk-objectstorage-generated:3.86.2")
    implementation("com.oracle.oci.sdk:oci-java-sdk-common-httpclient-jersey:3.86.2")
