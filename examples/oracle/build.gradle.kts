...
dependencies {
    implementation("com.oracle.oci.sdk:oci-java-sdk-objectstorage-generated:3.92.0")
    implementation("com.oracle.oci.sdk:oci-java-sdk-common-httpclient-jersey:3.92.0")
