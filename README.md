...
* [JSON examples](#json-examples)
  ...
  * [deserialize a json string with a top-level array of objects](#deserialize-a-json-string-with-a-top-level-array-of-objects)
<!-- TOC -->
...
### Function rule configuration
- Function handler: com.pega.lpst.PDF::setFieldsWithBase64
- Input parameters:
...
### Function rule configuration
- Function handler: com.pega.lpst.PDF::setFieldsWithURL
- Input parameters:
